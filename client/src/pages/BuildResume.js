...
import { resumeCountrys } from "../constants/resumeBuilder";
...
const ResumeBuilder = () => {
  ...
  const country = useSelector((state) => state.resumeBuilder.selectedResume.country);
  ...
  const resumeNameAndTemplateInput = (
    <>
      ...
      <TextField
        ...
        disabled={loading}
      >
        {Object.values(resumeCountrys).map((countryName) => (
